  ...
  return (
    <>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden opacity-15">
          <Image
            src="https://i.imgur.com/kb1aZ5W.png"
            alt=""
            width={100}
            height={100}
          ...
          />
          <Image
            src="https://i.imgur.com/hgAPJsi.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/UwEPjjs.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/VMKcVSH.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/fDIJvA3.png"
            alt=""
            width={80}
            height={80}
